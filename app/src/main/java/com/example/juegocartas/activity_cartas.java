...
LinearLayout linearLayout;
    int [] idBotonesIzquierdo,idBotonesDerecho,idTextViewContador,idTextViewJugador;
    Button[] arrayBotonesIzquierdo,arrayBotonesDerecho;
    Button buttonDerecho,buttonIzquierdo;
int [] contador;
